...
os::cmd::expect_success 'oc new-app --template=spark -p MASTER_NAME=master -p WORKER_NAME=worker -p SPARK_METRICS_ON=jolokia -p SPARK_IMAGE="$OPENSHIFT_SPARK_TEST_IMAGE"'
